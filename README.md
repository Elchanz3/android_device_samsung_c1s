...
## Kernel source 
Available at https://github.com/Elchanz3/android_kernel_samsung_c1s-twrp
...
```bash
git clone -b android-12.1 https://github.com/Elchanz3/android_device_samsung_c1s.git device/samsung/c1s
```
3. To build:
```bash
